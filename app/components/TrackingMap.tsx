  ...
  const initMap = () => {
    ...
    map.on("load", () => {
      ...
      riderEl.innerHTML = `<div style="
        width:44px;height:44px;background:linear-gradient(135deg,#FF6B35,#FFD23F);
    ...
    >
      ...
      >
        <div className="relative">
          <div className="w-11 h-11 bg-[#1A1A2E] border-2 border-[#FF6B35] rounded-full flex items-center justify-center text-xl shadow-lg animate-bounce">
            🛵
          </div>
